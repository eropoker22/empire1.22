...
export const CORE_EVENT_TYPES = {
  ...
  cityEventStarted: "city-event-started",
  cityEventSucceeded: "city-event-succeeded",
  cityEventFailed: "city-event-failed",
  cityEventRewardClaimed: "city-event-reward-claimed",
