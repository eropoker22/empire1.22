...
export const marketConfig = Object.freeze({
  ...
  // 25% convenience premium over the complete production chain; black-market risk is applied once downstream.
  resources: Object.freeze({
    ...
    "neon-dust": createResourceConfig("Neon Dust", 1530, "bulk", 0, 140),
    ...
    "pulse-shot": createResourceConfig("Pulse Shot", 2430, "tactical", 0, 90),
    "velvet-smoke": createResourceConfig("Velvet Smoke", 2630, "tactical", 0, 90),
    "tech-core": createResourceConfig("Tech Core", 2630, "tactical", 0, 80, 1.1),
    pistol: createResourceConfig("Pistole", 3750, "tactical", 0, 70),
    grenade: createResourceConfig("Granát", 3380, "tactical", 0, 70),
    vest: createResourceConfig("Vesta", 3750, "tactical", 0, 70),
    cameras: createResourceConfig("Kamery", 6000, "tactical", 0, 50),
    alarm: createResourceConfig("Alarm", 3380, "tactical", 0, 70),
    "combat-module": createResourceConfig("Combat Module", 9880, "strategic", 0, 24, 1.2),
    "ghost-serum": createResourceConfig("Ghost Serum", 8600, "strategic", 0, 18, 1.2),
    "overdrive-x": createResourceConfig("Overdrive X", 13300, "strategic", 0, 18, 1.2),
    smg: createResourceConfig("SMG", 10630, "strategic", 0, 16, 1.15),
    bazooka: createResourceConfig("Bazuka", 20880, "strategic", 0, 8, 1.3),
    "defense-tower": createResourceConfig("Obranná věž", 27630, "strategic", 0, 8, 1.3)
