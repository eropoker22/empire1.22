...
export const publicBuildingDefinitions: PublicBuildingDefinition[] = [
  ...
  building("strip_club", "Strip Club", "park", "Economy / influence / rumors / social network", "Strip Club pasivně vytváří peníze, vliv a drby. Vybrání cash, VIP klienti a soukromá party jsou samostatné akce s náklady, heatem a cooldownem.", perMinuteStat(75, 65, 259.2, 547.2, 1), [
