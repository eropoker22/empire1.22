...
export const publicBuildingDefinitions: PublicBuildingDefinition[] = [
  ...
  building("restaurant", "Restaurace", "commercial", "Economy / rumors / influence / city life", "Restaurace generuje čisté peníze, trochu vlivu a městské drby. Lokální tržby, kryté schůzky a síť kontaktů z ní dělají civilní oporu komerčních districtů. Stoly u okna, zadní vchod pro kurýry a kuchyně, kde se slyší víc než na ulici.", perMinuteStat(38, 0, 57.6, 172.8, 1), [
    action({ actionId: "restaurant_collect_revenue", label: "Vybrat tržby", description: "Vybere lokální tržby restaurace jako clean a dirty cash.", effectSummary: "+180 clean cash, +90 dirty cash, heat +1", cooldownMs: 30 * minute, outputGain: resources({ cash: 180, "dirty-cash": 90 }), heatGain: 1 }),
    action({ actionId: "restaurant_cover_meetings", label: "Krýt schůzky", description: "Na 30 minut zvedne lokální income restaurace a přidá vliv.", effectSummary: "+18 % clean/dirty income, +2 vliv, heat +1 na 30 minut", cooldownMs: 30 * minute, durationMs: 30 * minute, heatGain: 1, influenceChange: 2, effectModifiers: { cleanIncomeMultiplier: 1.18, dirtyIncomeMultiplier: 1.18 } }),
    action({ actionId: "restaurant_local_network", label: "Posílit lokální síť", description: "Na 30 minut posílí lokální vliv restaurace.", effectSummary: "+12 % vliv, +4 vliv, heat +2 na 30 minut", cooldownMs: 30 * minute, durationMs: 30 * minute, heatGain: 2, influenceChange: 4, effectModifiers: { influenceMultiplier: 1.12 } })
  ]),
