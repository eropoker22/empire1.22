...
const sourceFileBudgets = [
  ...
  ["apps/server/src/runtime/projections/gameplay-slice-projection-service.ts", 284],
  ...
  ["apps/server/src/admin/hosted/postgres-hosted-control-plane-repository.ts", 254],
  ...
  ["packages/game-core/src/projections/conflict-report-projection.ts", 260],
  ...
  ["apps/server/src/auth/gameplay-session-service.ts", 380],
