...
const sourceFileBudgets = [
  ...
  ["apps/server/src/transport/gameplay-command-payload-validation.ts", 317],
  ...
  ["packages/game-core/src/handlers/attackDistrict.ts", 567],
  ...
  ["packages/game-core/src/handlers/occupyDistrict.ts", 374],
