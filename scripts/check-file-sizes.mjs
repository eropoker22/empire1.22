...
const sourceFileBudgets = [
  ...
  ["apps/server/src/transport/gameplay-command-payload-validation.ts", 276],
  ...
  ["packages/game-core/src/handlers/allianceMembership.ts", 352],
  ["packages/game-core/src/handlers/attackDistrict.ts", 429],
