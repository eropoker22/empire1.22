...
const sourceFileBudgets = [
  ...
  ["apps/admin/src/read-models/admin-operations-console-view-model.ts", 666],
  ["apps/client/src/features/building-panel/index.ts", 255],
  ["apps/client/src/modals/overlay-state.ts", 432],
  ["apps/client/src/selectors/district-panel-view-model.ts", 322],
  ["apps/server/src/runtime/monitoring/admin-runtime-projection.ts", 638],
  ["apps/server/src/runtime/projections/gameplay-slice-projection-service.ts", 378],
  ["apps/server/src/transport/gameplay-command-payload-validation.ts", 334],
  ["apps/server/src/admin/hosted/hosted-runtime-worker.ts", 439],
  ["apps/server/src/admin/hosted/hosted-control-plane-service.ts", 271],
  ["apps/server/src/admin/hosted/in-memory-hosted-control-plane-repository.ts", 253],
  ["apps/server/src/admin/hosted/postgres-hosted-control-plane-repository.ts", 257],
  ["apps/server/src/admin/hosted/postgres-hosted-join-repository.ts", 258],
  ["apps/server/src/admin/read-only/postgres-admin-monitoring-data.ts", 262],
  ["apps/server/src/player-entry/postgres-player-entry-repository.ts", 692],
  ...
  ["packages/game-config/src/public/district-building-sets.ts", 266],
  ...
  ["packages/game-core/src/handlers/attackDistrict.ts", 595],
  ["packages/game-core/src/handlers/carDealerBuildingActions.ts", 272],
  ["packages/game-core/src/handlers/casinoBuildingActions.ts", 527],
  ["packages/game-core/src/handlers/centralBankPassive.ts", 259],
  ["packages/game-core/src/handlers/cityHallBuildingActions.ts", 305],
  ["packages/game-core/src/handlers/clinicBuildingActions.ts", 310],
  ["packages/game-core/src/handlers/collectProduction.ts", 281],
  ...
  ["packages/game-core/src/handlers/occupyDistrict.ts", 396],
  ...
  ["packages/game-core/src/projections/district-building-action-projection.ts", 1069],
  ["packages/game-core/src/projections/district-building-action-view-helpers.ts", 260],
  ["packages/game-core/src/projections/district-building-civil-stats.ts", 371],
  ["packages/game-core/src/projections/district-building-finance-stats.ts", 266],
  ["packages/game-core/src/projections/conflict-report-projection.ts", 265],
  ...
  ["packages/game-core/src/rules/heists/heistSystem.ts", 1999],
  ...
  ["packages/game-core/src/rules/police/triggerRaid.ts", 255],
  ["packages/shared-types/src/admin/read-models/admin-read-only-views.ts", 257],
  ["packages/shared-types/src/views/district-panel-building-view.ts", 271],
  ["packages/shared-types/src/views/district-panel-view.ts", 357],
  ...
  ["packages/game-config/src/validation/validate-mode-config.ts", 257],
  ["apps/client/src/browser/gameplay-slice-page.ts", 466],
  ["apps/server/src/auth/gameplay-session-service.ts", 393],
  ["apps/server/src/netlify/admin-read-only-netlify.ts", 271],
  ["apps/server/src/netlify/gameplay-slice-function.ts", 295],
  ...
  ["apps/server/src/runtime/persistence/postgres/postgres-snapshot-repository.ts", 254],
  ["tools/debug/src/closed-alpha-20p-simulation/simulation.ts", 5736],
  ...
  ["tools/seed/hosted-multiplayer-core-scenario.ts", 258]
];
...
const browserPresentationBudgets = new Map([
  ...
  ["page-assets/js/app/map/serverMapLayerRenderer.js", 252],
  ["page-assets/js/app/runtime/serverGameplayCommandTransport.js", 427],
  ["page-assets/js/app/ui/serverGameplayDistrictView.js", 279]
]);
