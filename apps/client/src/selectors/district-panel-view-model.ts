...
import { createDistrictPanelBuildingViewModels } from "./district-panel-building-view-model";
...
export const createDistrictPanelViewModel = (
  ...
  return {
    ...
    buildingSummary: !slice.district.intelKnown
      ? "Budovy nezjištěny"
      : slice.district.status === "destroyed"
    ...
    trap: slice.district.trap
      ? {
          actionLabel: slice.district.trap.activeTrap
            ? "Past nastražena"
            : slice.district.trap.relocationSource?.canRelocate
              ? "Přesunout skrytou past"
              : "Nastražit skrytou past",
          activeLabel: slice.district.trap.activeTrap
            ...
            : slice.district.trap.relocationSource?.canRelocate
              ? "Past je aktivní v jiném vlastním districtu."
              : null,
