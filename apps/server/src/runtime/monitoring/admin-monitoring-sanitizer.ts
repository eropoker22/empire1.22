...
export const sanitizeAdminMonitoringText = (value: string): string =>
  value
...
export const sanitizeAdminMonitoringPayloadPreview = (
  value: unknown,
  maxLength = 360
): string => {
  ...
  const sanitized = sanitizeAdminMonitoringText(serialized);
