...
describe("page onboarding smoke", () => {
  ...
  it("keeps the login to game page contract wired", () => {
    ...
    expect(page("game.html")).toContain('id="game-overlay-region" class="game-overlay-roots"');
    expect(page("game.html")).not.toContain("Overlay roots");
    expect(page("game.html")).not.toContain("mount-point--overlay");
