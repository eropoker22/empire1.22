...
function createBuildings() {
  const names = ["Lékárna", "Drug Lab", "Továrna", "Zbrojovka", "Pašovací tunel", "Pouliční dealeři", "Strip club", "Večerka", "Datové centrum", "Energetická stanice", "Sklad", "Fitness Club", "Kasino", "Herna", "Autosalon", "Směnárna", "Restaurace", "Bytový blok", "Klinika"];
  const zones = Object.keys(ZONE_META);
...
function pickBuildings(index) {
  const pool = ["Lékárna", "Drug Lab", "Továrna", "Zbrojovka", "Sklad", "Kasino", "Datové centrum", "Klinika", "Pašovací tunel"];
