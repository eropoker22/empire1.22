...
const ACTION_UI_BY_ID = Object.freeze({
  ...
  "prodat zasobu": Object.freeze({ label: "Prodat zásobu", icon: "DEAL", category: "dirty-cash", badge: "Distribuce" }),
  "spustit prodej": Object.freeze({ label: "Prodat zásobu", icon: "DEAL", category: "dirty-cash", badge: "Distribuce" }),
  ...
  "soukroma party": Object.freeze({ label: "Soukromá party", icon: "INF", category: "influence", badge: "Vliv" }),
  "stabilizovat sit": Object.freeze({ label: "Stabilizovat síť", icon: "PWR", category: "support", badge: "Síť" }),
  "napajet vyrobu": Object.freeze({ label: "Prodat přebytek", icon: "PWR", category: "economy", badge: "Prodej" }),
  "prodat prebytek": Object.freeze({ label: "Prodat přebytek", icon: "PWR", category: "economy", badge: "Prodej" }),
