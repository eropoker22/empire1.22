...
export function getDistrictPopupElements(root) {
  return {
    ...
    popupDefense: query(root, selectors.DISTRICT_POPUP_DEFENSE_SELECTOR),
    popupDefensePower: query(root, selectors.DISTRICT_POPUP_DEFENSE_POWER_SELECTOR),
    popupResidents: query(root, selectors.DISTRICT_POPUP_RESIDENTS_SELECTOR),
    popupIncome: query(root, selectors.DISTRICT_POPUP_INCOME_SELECTOR),
    popupHeat: query(root, selectors.DISTRICT_POPUP_HEAT_SELECTOR),
