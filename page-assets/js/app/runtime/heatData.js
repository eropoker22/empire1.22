export const GANG_HEAT_DIRTY_COST = 500;
export const GANG_HEAT_DIRTY_REDUCTION = 10;
export const GANG_HEAT_CLEAN_COST = 300;
export const GANG_HEAT_CLEAN_REDUCTION = 15;
export const GANG_HEAT_INFLUENCE_COST = 20;
export const GANG_HEAT_INFLUENCE_REDUCTION = 10;
...
export const GANG_HEAT_RAID_PROTECTION_MS = 5 * 60 * 60 * 1000;
