...
export const GANG_HEAT_DIRTY_REDUCTION = 15;
export const GANG_HEAT_CLEAN_COST = 5_000;
export const GANG_HEAT_CLEAN_REDUCTION = 25;
export const GANG_HEAT_INFLUENCE_COST = 20;
export const GANG_HEAT_INFLUENCE_REDUCTION = 25;
