export const PRODUCTION_BUILDING_CONFIG = Object.freeze({
  pharmacy: Object.freeze({
    ...
    infoActions: Object.freeze(["Command výrobu hned spustí.", "Vstupy se při startu odečtou atomicky.", "Výstup se připíše do globálního SKLADU až po doběhnutí serverového času."])
  }),
  druglab: Object.freeze({
    ...
    infoActions: Object.freeze(["Každá látka se po commandu zařadí do výroby.", "Vstupy se odečtou při startu a výstup vznikne po serverovém čase.", "Ghost Serum a Overdrive X se spotřebovávají pouze při aktivaci strategického boostu."])
  }),
  armory: Object.freeze({
    ...
    infoActions: Object.freeze(["Zvolené kusy se po commandu zařadí do výrobní fronty.", "Náklady se odečtou při startu; výstup vznikne po serverovém čase.", "High-tier recepty spotřebovávají Combat Module z globálního SKLADU."])
  })
});
